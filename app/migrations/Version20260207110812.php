...
final class Version20260207110812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dish (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(100) NOT NULL, image VARCHAR(255) DEFAULT NULL, width DOUBLE PRECISION NOT NULL, height DOUBLE PRECISION NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE placement (id INT AUTO_INCREMENT NOT NULL, x DOUBLE PRECISION NOT NULL, y DOUBLE PRECISION NOT NULL, width DOUBLE PRECISION NOT NULL, height DOUBLE PRECISION NOT NULL, stack_id INT DEFAULT NULL, stack_index INT DEFAULT NULL, shelf_id INT NOT NULL, dish_id INT NOT NULL, INDEX idx_placement_shelf (shelf_id), INDEX idx_placement_dish (dish_id), INDEX idx_placement_stack (stack_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
